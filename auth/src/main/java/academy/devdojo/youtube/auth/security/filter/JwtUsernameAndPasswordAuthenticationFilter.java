...
public class JwtUsernameAndPasswordAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    /**
     * Vai tentar fazer a autenticação do usuário,
     * delegando a responsabilidade para o UserDetailService.
     *
     * @param request
     * @param response
     * @return
     ...
     */
    @Override
    @SneakyThrows // Encapsula o request.getInputStream() em uma exceção do tipo runtime
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) {
        ...
        log.info("Creating the authentication object for the user '{}' and calling UserDetailServiceImplementation loadUserByUserName", applicationUser.getUsername());
